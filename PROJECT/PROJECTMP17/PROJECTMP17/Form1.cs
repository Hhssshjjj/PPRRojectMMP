...
namespace PROJECTMP17
{
    public partial class Form1 : Form
    {
        ...
        private void buttondotter_Click(object sender, EventArgs e)
        {
            textBox1.Text = textBox1.Text + ",";
        }
        ...
        private void buttonxody_Click(object sender, EventArgs e)
        {
            textBox1.Text = textBox1.Text + "^";
        }
        ...
        private void button1koren_Click(object sender, EventArgs e)
        {
            string s = textBox1.Text;
            float w = Convert.ToSingle(s);
